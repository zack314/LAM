...
**[April 30, 2025]** We have released a [Gradio export feature](tools/README.md) that allows users to chat with any LAM-generated 3D digital humans on OpenAvatarChat. 🔥 <br>
...
python app_lam.py
```
If you want to export ZIP files for real-time conversations on OpenAvatarChat, please refer to [Document](tools/README.md).
```bash
